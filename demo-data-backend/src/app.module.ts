...
import { DemoSeedingModule } from './demo-seeding/demo-seeding.module';
import { TenantMigrationCreateAssets001 } from './demo-seeding/tenant-migrations/001-create-assets';
    ...
    return {
      ...
      imports: [
        ...
        LibModule.forRootAsync({
          ...
          tenantMigrations: [TenantMigrationCreateAssets001],
          tenantMigrationPrefix: TABLE_PREFIX,
          imports: [DemoSeedingModule],
        }),
