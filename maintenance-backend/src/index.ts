...
(async (): Promise<void> => {
  ...
  SwaggerModule.setup(
    ...
    SwaggerModule.createDocument(
      app,
      new DocumentBuilder()
        .setTitle('Shopfloor.io Maintenance Manager Backend')
        .setDescription('API documentation of Shopfloor.io Maintenance Manager Backend')
        .setVersion('3.0')
        .addServer('../../', 'Maintenance Service')
        .addBearerAuth()
        .build(),
    ),
  );
